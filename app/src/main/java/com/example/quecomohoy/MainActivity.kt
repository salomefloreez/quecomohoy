...
val listaRecetas = arrayListOf<ClaseParaRecetas>(
    ...
    ClaseParaRecetas("Comida","Filete de Pescado al Horno", "35 minutos", "Medio", "", "descripcion" ),
    ClaseParaRecetas("Comida","Ensalada Campera", "20 minutos", "Facil", "", "descripcion" ),
    ClaseParaRecetas("Cena","Revuelto de Setas y Ajetes", "20 minutos", "Medio", "", "descripcion" ),
    ClaseParaRecetas("Cena","Sepia a la plancha", "20 minutos", "Facil", "", "descripcion" ),
    ClaseParaRecetas("Cena","Calabacín relleno de atún y huevo", "30 minutos", "Medio", "", "descripcion" ),
    ClaseParaRecetas("Cena","Sopa de Calabaza", "40 minutos", "Medio", "", "descripcion" ),
    ClaseParaRecetas("Cena","Saltadeado de Verduras y Tofu", "35 minutos", "Facil", "", "descripcion" ),
    ClaseParaRecetas("Cena","Tortilla de Espinacas y Piñones", "20 minutos", "Medio", "", "descripcion" ),
    ClaseParaRecetas("Cena","Pimientos rellenos de Bacalao", "45 minutos", "Dificil", "", "descripcion" ),
